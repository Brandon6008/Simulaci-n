 ...
 * -------------------------------------------------------------
 * Descripción:
 * Esta clase implementa el modelo matemático de Regresión Lineal
 * Simple (SLR) orientado a objetos, utilizando los datos del caso
 * Benetton. Calcula los coeficientes B0 (intercepto), B1 (pendiente)
...
public class SimpleLinearRegression {
    ...
    /**
     * Método para calcular los coeficientes B0 y B1
    ...
    /**
     * Método para predecir un valor de Y a partir de un valor X.
     */
